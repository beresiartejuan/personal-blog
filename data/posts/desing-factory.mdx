...
Sí eres atento, te habras dado cuenta de que estamos usando polimorfismo. Y ya solo nos falta dar un paso más para implementar el patrón Factory: Nuestra fabrica de vehiculos. Así es, le delegamos la tarea de decidir en que vehiculo llevar el pedido a otra función o clase.
